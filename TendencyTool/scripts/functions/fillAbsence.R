...
#' - abundance : num, number or proportion of individuals seen
#' - ID : char, a unique identifier containing date - site - point information
#'
#' @param method
...
#' @export
#' @example
fillAbsence <- function(data, method = "once"){
